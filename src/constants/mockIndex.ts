...
const MockIndex = [
    createMockData(1, 'DeFi Pulse Index', 'DPI', 21202121, 70.38, 1.9, -0.5, -0.8, -75.4, [{ name:"Bitcoin", symbol:"BTC", percent: 50}, {name:"Ethereum", symbol:"ETH", percent:25}, {name:"Avalanche", symbol:"AVAX", percent:25}]),
